...
io(4) = linio([mdlPlant '/Pendulum and Cart System'],2,'openoutput');
io(5) = linio([mdlPlant '/Pendulum and Cart System'],3,'openoutput');
io(6) = linio([mdlPlant '/Pendulum and Cart System'],4,'openoutput');
...
y0 = [op_report.Outputs(1).y;op_report.Outputs(2).y;op_report.Outputs(3).y;op_report.Outputs(4).y];
...
plant.OutputName = {'x';'xdot';'theta';'thetadot'};
...
mpcobj.Weights.OV = 100*[1.2 0 1 0]; % weights are for x and theta respectively
